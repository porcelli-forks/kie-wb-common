...
package org.kie.workbench.common.screens.server.management.client.widget.confirm;
...
public class YesNoCancelPopup extends BaseModal {
    ...
    public void setScrollHeight( final int height ) {
        this.scroll.getElement().getStyle().setHeight( height, Style.Unit.PX );
    }
